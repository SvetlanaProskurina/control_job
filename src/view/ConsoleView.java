...
public class ConsoleView implements View {
  ...
  public void showKennelRegistry() {
    ...
    printCaption("Питомник домашних и вьючных животных", " ");
    printLineWithSymbol("#", SIZE_LINE);
    printRegistryHeader();
    printLineWithSymbol("+", SIZE_LINE);
   ...
   *                  род_животного - содержит значения из перечисления AnimalGenius
  ...
  private void printRegistryHeader() {
    String header = String.format(COLUMN_HEADER_FORMAT, "№", "Имя", "Дата рождения", "Возраст(мес.)",
        "Род животного");
